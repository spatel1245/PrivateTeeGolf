        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
            ...
            <div>
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <span class="font-serif text-gray-900 text-2xl font-bold tracking-tight">Private Tee <span class="text-hunter">Golf.</span></span>
                </div>
                <div class="text-xs text-gray-700 space-y-2">
                    ...
                    <div class="flex items-center gap-2 pt-1">
                        <span class="w-1.5 h-1.5 rounded-full bg-hunter animate-pulse flex-shrink-0"></span>
                        <span class="text-hunter font-semibold tracking-wide">Open 24/7/365</span>
                    </div>
                </div>
            </div>

            <!-- Col 2: Map -->
            <div class="rounded-xl overflow-hidden border border-gray-200 shadow-sm" style="height: 180px;">
                <iframe
                    src="https://maps.google.com/maps?q=5351+US-30,+Greensburg,+PA+15601&output=embed"
                    width="100%"
                    height="180"
                    ...
                    title="Private Tee Golf on Google Maps">
                </iframe>
            </div>
            ...
            <div class="flex flex-col gap-4 md:items-end">
                ...
                <a href="mailto:info@privateteegolf.com" class="inline-flex items-center gap-2 text-hunter hover:text-emerald-600 transition group">
                    ...
                    <span class="text-sm font-medium border-b border-hunter/30 group-hover:border-emerald-600">info@privateteegolf.com</span>
                </a>
                <div class="flex gap-4 mt-1">
                    <a href="https://www.instagram.com/private.tee.golf" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-hunter transition" aria-label="Instagram">
                    ...
                    <a href="https://www.facebook.com/privateteegolf/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-hunter transition" aria-label="Facebook">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                        </svg>
                    </a>
                    <a href="https://www.linkedin.com/company/private-tee-golf/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-hunter transition" aria-label="LinkedIn">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
